...
int main(){
    ...
    int team1 = 48;
    int team2 = 39;
    int headToHeadDifferential = -100;
    ...
    int homeIDs[NUM_GAMES]        = {48,    37,    38,    48,    45,    38,    51,    61,    59,    66};
    int awayIDs[NUM_GAMES]        = {50,    46,    65,    39,    42,    63,    48,    65,    58,    48};
    ...
    headToHeadDifferential = headToHeadWL(team1, team2, homeIDs, awayIDs, homeTeamWins, NUM_GAMES);
    printf("Head to Head Differential: %d\n", headToHeadDifferential);
